...
async function main(client) {
  ...
  for (const item of pairs) {
    ...
    response = await clientAcc.run("returnDepositFromPair", {pairAddr:item});
    console.log('Contract run returnDepositFromPair with output', response.decoded.output, response.transaction.id);
