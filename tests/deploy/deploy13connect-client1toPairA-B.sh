...
echo ========================================================================
echo Connect client1 to pairA_B

CLIENT_ADDR_FILE="./client1/address.json"
...
RESULT_DEPLOY=$($TONOS_CLI -u $NETWORK call --abi ./sol/DEXclient.abi.json --sign ./client1/deploy.keys.json $CLIENT_ADDR connectPair $ROOT_DATA | grep "statusConnection" | cut -c 22-)
